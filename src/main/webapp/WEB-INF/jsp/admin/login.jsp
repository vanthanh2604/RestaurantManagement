    ...
    <div class="container-fluid h-100">
        <div class="row flex-row h-100 bg-white">
            <div class="col-xl-8 col-lg-6 col-md-5 p-0 d-md-block d-lg-block d-sm-none d-none">
                <div class="lavalite-bg" style="background-image: url('/resources/img/auth/login-bg.jpg')">
            ...
            <div class="col-xl-4 col-lg-6 col-md-7 my-auto p-0">
                <div class="authentication-form mx-auto">
                    <div class="logo-centered">
                        <a href="/resources/index.html"><img src="/resources/src/img/brand.svg" alt=""></a>
                    </div>
...
<script src="/resources/plugins/perfect-scrollbar/dist/perfect-scrollbar.min.js"></script>
<script src="/resources/plugins/screenfull/dist/screenfull.js"></script>
