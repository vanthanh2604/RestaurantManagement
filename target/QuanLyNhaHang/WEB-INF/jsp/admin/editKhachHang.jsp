            ...
            <div id="AddProduct" tabindex="1" role="dialog" aria-hidden="false">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <mvc:form autocomplete="off" modelAttribute="khachhang" action="/admin/khachhang/update" method="post" class="form-horizontal">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn" data-dismiss="modal"><i class="fa fa-undo" aria-hidden="true"></i><a href="/admin/khachhang/list">Cance</a></button>
                                </div>
                        </mvc:form>
                    </div>
                </div>
